...
var stringifyCallSite = require('./callsite-stringify.js');
var parseCallSite = require('./callsite-parse.js');
...
var CallSite = {
	...
	getScriptNameOrSourceURL: function(){
		return this.source ? this.source : (this.sourceURL ? this.sourceURL : this.getFileName());
	},
